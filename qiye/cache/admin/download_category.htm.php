<?php /* Smarty version 2.6.26, created on 2016-01-26 18:25:16
         compiled from download_category.htm */ ?>
...
" class="actionBtn add"><?php echo $this->_tpl_vars['action_link']['text']; ?>
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
        <th width="120" align="left"><?php echo $this->_tpl_vars['lang']['download_category_name']; ?>
</th>
...
?>
 ...
 <a href="download.php?cat_id=<?php echo $this->_tpl_vars['cate']['cat_id']; ?>
"><?php echo $this->_tpl_vars['cate']['cat_name']; ?>
        ...
        <td align="center"><a href="download_category.php?rec=edit&cat_id=<?php echo $this->_tpl_vars['cate']['cat_id']; ?>
"><?php echo $this->_tpl_vars['lang']['edit']; ?>
</a> | <a href="download_category.php?rec=del&cat_id=<?php echo $this->_tpl_vars['cate']['cat_id']; ?>
...
" class="actionBtn"><?php echo $this->_tpl_vars['action_link']['text']; ?>
    ...
    <form action="download_category.php?rec=<?php echo $this->_tpl_vars['form_action']; ?>
" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="80" align="right"><?php echo $this->_tpl_vars['lang']['download_category_name']; ?>
</td>
       <td>
