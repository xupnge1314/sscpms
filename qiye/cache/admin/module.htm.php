<?php /* Smarty version 2.6.26, created on 2016-01-26 18:13:01
...
">
   ...
   <ul class="tab">
    <li><a href="module.php"<?php if ($this->_tpl_vars['rec'] == 'default'): ?> class="selected"<?php endif; ?>><?php echo $this->_tpl_vars['lang']['module_cloud']; ?>
</a></li>
    <li><a href="module.php?rec=local"<?php if ($this->_tpl_vars['rec'] == 'local'): ?> class="selected"<?php endif; ?>><?php echo $this->_tpl_vars['lang']['module_local']; ?>
</a></li>
...
')</script>
   <div class="pager"></div>
   <?php endif; ?>
   <?php if ($this->_tpl_vars['rec'] == 'local'): ?>
   <div class="install">
   <h2><?php echo $this->_tpl_vars['lang']['module_local_cue']; ?>
</h2>
   <form action="module.php?rec=install" method="post" enctype="multipart/form-data">
    <input type="file" name="zipfile" size="38" class="inpFlie" />
    <input type="hidden" name="token" value="<?php echo $this->_tpl_vars['token']; ?>
" />
    <input name="submit" class="btn" type="submit" value="现在安装" />
   </form>
   </div>
   <?php endif; ?>
