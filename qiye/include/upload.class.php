...
class Upload {
     ...
     * +----------------------------------------------------------
     */
    function Upload($images_dir = '../upload/', $thumb_dir = 'thumb/', $upfile_type = 'jpg,gif,png,pdf', $upfile_size_max = '102400') {  //修改上传类型及大小
    ...
    function upload_image($upfile, $image_name = '') {
        ...
        //echo $upfile_name;  echo $_FILES[$upfile]["tmp_name"];
    ...
    function upload_gallery($upfile, $images_url, $image_name = '') {
        ...
        if ($upfile_ok) {
            ...
            if ($img_size_kb > $this->upfile_size_max) {
                ...
                echo '<input type="hidden" name="gallery[]" value="' . $images_url . $photo . '" /></li>';
            }
        } else {
