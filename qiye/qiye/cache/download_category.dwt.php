<?php /* Smarty version 2.6.26, created on 2016-03-15 15:18:04
...
<link href="http://www.44ce.cn/qiye/theme/default/download.css" rel="stylesheet" type="text/css" />
...
unset($_smarty_tpl_vars);
 ?> </div>
  ...
  <form name="action" method="post" action="download.php">
    <div align='center' style="margin:10px">
          <p style="padding:10px"> <?php echo $this->_tpl_vars['lang']['sign']; ?>
:
            <input type="text" name="sign" value="" size="50" style="height:30px" class="inpMain" /></p>

          <p style="padding:10px"><input name="submit" class="btn" type="submit" value="<?php echo $this->_tpl_vars['lang']['btn_submit']; ?>
" /></p>
    </div>
      </form>
