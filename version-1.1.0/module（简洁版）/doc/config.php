...
$config->doc->editor->edit   = array('id' => 'content,digest,comment,info,remark', 'tools' => 'fullTools');
...
$config->doc->search['fields']['project_name']            = $lang->doc->project_name;
$config->doc->search['fields']['organization']            = $lang->doc->organization;
$config->doc->search['fields']['money']            = $lang->doc->money;
$config->doc->search['fields']['day']            = $lang->doc->day;
$config->doc->search['fields']['info']            = $lang->doc->info;
$config->doc->search['fields']['remark']            = $lang->doc->remark;
$config->doc->search['fields']['add_user']            = $lang->doc->add_user;
$config->doc->search['fields']['add_time']            = $lang->doc->add_time;
...
$config->doc->search['params']['project_name']         = array('operator' => 'include', 'control' => 'input',  'values' => '');
$config->doc->search['params']['organization']      = array('operator' => 'include', 'control' => 'input',  'values' => '');
$config->doc->search['params']['money']     = array('operator' => '>=',      'control' => 'input',  'values' => '');
$config->doc->search['params']['day']     = array('operator' => '>=',      'control' => 'input',  'values' => '' , 'class' => 'date');
$config->doc->search['params']['info']         = array('operator' => 'include', 'control' => 'input',  'values' => '');
$config->doc->search['params']['remark']      = array('operator' => 'include', 'control' => 'input',  'values' => '');
$config->doc->search['params']['add_user']      = array('operator' => 'include', 'control' => 'input',  'values' => '');
$config->doc->search['params']['add_time']     = array('operator' => '>=',      'control' => 'input',  'values' => '' , 'class' => 'date');
