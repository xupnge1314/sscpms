...
Date: 2015-10-14 18:17:41
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `zt_product_copy`
-- ----------------------------
DROP TABLE IF EXISTS `zt_product_copy`;
CREATE TABLE `zt_product_copy` (
  ...
  `project` varchar(255) NOT NULL COMMENT '测试项目',
